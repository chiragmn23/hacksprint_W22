...
import { TrainingTaskListRelationFilter } from "../../trainingTask/base/TrainingTaskListRelationFilter";

@InputType()
class LocalModelWhereInput {
  @ApiProperty({
    required: false,
    type: StringFilter,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => TrainingTaskListRelationFilter,
  })
  @ValidateNested()
  @Type(() => TrainingTaskListRelationFilter)
  @IsOptional()
  @Field(() => TrainingTaskListRelationFilter, {
    nullable: true,
  })
  trainingTasks?: TrainingTaskListRelationFilter;
}

export { LocalModelWhereInput as LocalModelWhereInput };
