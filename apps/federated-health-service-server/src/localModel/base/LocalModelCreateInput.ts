...
class LocalModelCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TrainingTaskCreateNestedManyWithoutLocalModelsInput,
  })
  @ValidateNested()
  @Type(() => TrainingTaskCreateNestedManyWithoutLocalModelsInput)
  @IsOptional()
  @Field(() => TrainingTaskCreateNestedManyWithoutLocalModelsInput, {
    nullable: true,
  })
  trainingTasks?: TrainingTaskCreateNestedManyWithoutLocalModelsInput;
}

export { LocalModelCreateInput as LocalModelCreateInput };
